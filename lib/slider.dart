                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Center(child: Text('La façon la plus simple de souhaiter un joyeux anniversaire à vos proche ',style: TextStyle(fontSize: 18.0),))
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Center(child: Text('Personnalisez les images et vidéos pour les envoyer à vos proches',style: TextStyle(fontSize: 18.0),))
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(height: 15.0),
                            Center(child: Text('Offrez des cadeaux spéciaux à \nceux qui vous sont chers !!!',style: TextStyle(fontSize: 18.0),))
